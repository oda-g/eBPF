...
* | kern_versionに入れる値は、カーネルと合っていないといけない。本コードでは、266001とハードコーディングしているが、できれば、マクロLINUX_VERSION_CODE(linux/version.h)(266002になっている)を使用するのが望ましい。
